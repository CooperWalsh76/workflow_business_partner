sap.ui.define([
	...
	"sap/ui/Device",
	"demo/sap/com/Approval/model/models"
], function(UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("demo.sap.com.Approval.Component", {
		...
		init: function() {
			...
			//	var processContext = processModel.getData().BPRequest;
		...
		_triggerComplete: function(taskId, approvalStatus, refreshTask) {
			...
			$.ajax({
				...
				success: function(result, xhr, data) {
					...
					var dataText = "{ \"status\":\"COMPLETED\",\"context\": {\"ApprovalStatus\": \"" + approvalStatus + "\" }}";
					$.ajax({
